...
Source Database       : carsale

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2019-06-15 22:55:55
*/
...
CREATE TABLE `brand` (
  ...
  `status` varchar(1) NOT NULL DEFAULT '1' COMMENT '品牌状态（0：删除状态，1：正常状态）',
...
CREATE TABLE `car` (
  ...
  `type` varchar(32) NOT NULL COMMENT '车辆型号',
  `color` varchar(16) NOT NULL COMMENT '车辆颜色',
  ...
  `status` varchar(1) NOT NULL COMMENT '车辆状态（0：停售，1：在售，2：停售）',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `series_id` (`series_id`) USING BTREE,
  CONSTRAINT `car_ibfk_1` FOREIGN KEY (`series_id`) REFERENCES `series` (`series_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of car
-- ----------------------------
INSERT INTO `car` VALUES ('19010400001', '2', '2018款 730Li 领先型 M运动套装', '矿石白', '790000.00', '830000.00', '1', '2018-12-04 17:20:13', '0');
INSERT INTO `car` VALUES ('19010400002', '3', '2019款 525Li 豪华套装', '宝石青', '410000.00', '439000.00', '0', '2019-01-04 17:22:35', '1');
INSERT INTO `car` VALUES ('19010400003', '3', '2019款 530Li 尊享型 豪华套装', '勃艮第红', '498000.00', '523000.00', '3', '2019-01-04 17:24:50', '1');
INSERT INTO `car` VALUES ('19010400004', '4', '2019款 E 320 L 4MATIC', '曜岩黑', '601000.00', '629000.00', '2', '2019-01-04 17:35:18', '1');
INSERT INTO `car` VALUES ('19010400005', '5', '2019款 GLC 300 L 4MATIC 豪华型', '皓砂银', '556000.00', '578000.00', '5', '2019-01-04 17:37:32', '1');
INSERT INTO `car` VALUES ('19010400006', '6', '2018款 30周年年型 45 TFSI quattro 运动型', '传奇黑', '489000.00', '507000.00', '2', '2018-12-04 17:42:07', '1');
INSERT INTO `car` VALUES ('19011200001', '7', '2019款 630i 豪华设计套装', '巴西棕', '585000.00', '599999.00', '1', '2019-01-12 21:37:13', '1');
INSERT INTO `car` VALUES ('19011200002', '7', '2019款 630i 豪华设计套装', '神秘灰', '585000.00', '599999.00', '2', '2019-01-12 21:37:42', '1');
...
INSERT INTO `car` VALUES ('19011200006', '8', '2019款 240TURBO CVT两驱舒适版 国V', '珍珠白', '165000.00', '178000.00', '3', '2019-01-12 21:44:07', '1');
INSERT INTO `car` VALUES ('19011200007', '8', '2019款 240TURBO CVT两驱舒适版 国V', '彩晶黑', '165000.00', '178000.00', '1', '2019-01-12 21:44:30', '1');
INSERT INTO `car` VALUES ('19011200008', '8', '2019款 240TURBO CVT两驱风尚版 国VI', '彩晶黑', '190000.00', '203888.00', '1', '2019-01-12 21:46:01', '1');
...
INSERT INTO `car` VALUES ('19011200011', '9', '2018款 260TURBO 精英版', '宝石红', '168000.00', '186888.00', '5', '2018-11-12 21:53:17', '1');
INSERT INTO `car` VALUES ('19011200012', '10', '2018款 典藏版 40 TFSI 进取型', '柚木棕', '380000.00', '399999.00', '0', '2019-01-12 21:57:15', '1');
INSERT INTO `car` VALUES ('19011200013', '10', '2018款 典藏版 40 TFSI 技术型', '幻影黑', '410000.00', '428000.00', '2', '2019-01-12 21:58:35', '1');
INSERT INTO `car` VALUES ('19011200014', '11', '2019款 C 260 运动版', '曜岩黑', '310000.00', '325888.00', '2', '2019-01-12 22:02:07', '1');
INSERT INTO `car` VALUES ('19011200015', '11', '2019款 C 260 运动版 4MATIC', '北极白', '365000.00', '383000.00', '2', '2019-01-12 22:03:52', '1');
...
INSERT INTO `car` VALUES ('19021600002', '13', '2019款 双擎 2.5L 基础版', '传奇黑', '233900.00', '244999.00', '3', '2019-02-16 15:31:40', '1');
INSERT INTO `car` VALUES ('19021600003', '13', '2019款 双擎 2.5L 中配版', '传奇黑', '245000.00', '255999.00', '1', '2019-02-16 15:32:48', '1');
INSERT INTO `car` VALUES ('19021600004', '13', '2019款 双擎 2.5L 高配版', '传奇黑', '285000.00', '289999.00', '1', '2019-02-16 15:33:31', '1');
INSERT INTO `car` VALUES ('19052200001', '9', '2018款 混动 2.0L E-CVT 锐酷版', '魅力红', '150000.00', '169800.00', '4', '2019-05-22 15:28:39', '1');
...
CREATE TABLE `customer` (
  ...
  `name` varchar(10) NOT NULL COMMENT '顾客姓名',
  `phone` varchar(11) NOT NULL COMMENT '顾客电话',
  `id_card` varchar(20) NOT NULL COMMENT '顾客身份证号',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '顾客信息创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('19010610001', '吴智枫', '18826123456', '371321199701014000', '2019-01-06 10:36:12');
...
CREATE TABLE `employee` (
  ...
  `role` varchar(1) NOT NULL COMMENT '员工角色（0：经理，1：销售）',
  `name` varchar(10) NOT NULL COMMENT '员工姓名',
  `password` varchar(20) NOT NULL COMMENT '员工登录密码',
  `id_card` varchar(20) NOT NULL COMMENT '员工身份证号',
  `phone` varchar(11) NOT NULL COMMENT '员工电话号码',
  `gender` varchar(1) NOT NULL COMMENT '员工性别：''男''&''女''',
  `salary` decimal(12,2) NOT NULL COMMENT '员工薪资',
  `entry_time` date NOT NULL COMMENT '员工入职时间',
  `status` varchar(1) NOT NULL COMMENT '员工状态（0：离职，1：在职）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `id_card` (`id_card`) USING BTREE,
  UNIQUE KEY `phone` (`phone`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` VALUES ('19061210001', '杨波', '13838384388', '2019-06-13', '继续努力');
INSERT INTO `feedback` VALUES ('19061410001', '张洪睿', '19903660122', '2019-06-15', '继续努力');
INSERT INTO `feedback` VALUES ('19061410002', '刘桐旭', '18896060696', '2019-06-15', '继续努力');
INSERT INTO `feedback` VALUES ('19061410003', '马天昊', '18855550999', '2019-06-15', '继续努力');
INSERT INTO `feedback` VALUES ('19061410004', '朱立豪', '19902660366', '2019-06-15', '继续努力');
INSERT INTO `feedback` VALUES ('19061410005', '尹亚', '13606553033', '2019-06-15', '继续努力');
...
-- Records of market
-- ----------------------------
INSERT INTO `market` VALUES ('19061210002', '益阳', '13331222033', '2019-06-13', '宣传');
INSERT INTO `market` VALUES ('19061410001', '林雪', '18996992622', '2019-06-21', '宣传');
INSERT INTO `market` VALUES ('19061410002', '关霞岩', '18866660002', '2019-06-16', '宣传');
INSERT INTO `market` VALUES ('19061410003', '廖忠', '18866660005', '2019-06-17', '宣传');
INSERT INTO `market` VALUES ('19061410004', '韩行浩', '15566660003', '2019-06-18', '宣传');
INSERT INTO `market` VALUES ('19061410005', '邢轮彦', '15566660004', '2019-06-16', '宣传');
...
CREATE TABLE `order` (
  ...
  `status` varchar(1) NOT NULL COMMENT '订单状态（0：未支付，1：已支付，2：已取消）',
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('123', '19010610005', '123456', '234566.00', '0', '2019-06-15 17:01:08', null, '2019-06-15 17:01:08');
INSERT INTO `order` VALUES ('190110000001', '19010610001', '1901001', '2037000.00', '1', '2019-05-04 20:43:06', '2019-06-15 11:13:40', '2019-06-14 22:06:05');
INSERT INTO `order` VALUES ('190110000002', '19010610002', '1810002', '578000.00', '1', '2019-01-10 20:43:33', '2019-06-15 10:06:12', '2019-06-14 22:06:18');
INSERT INTO `order` VALUES ('190110000003', '19010610003', '1810002', '878000.00', '1', '2019-01-10 20:44:10', '2019-06-15 22:35:55', '2019-06-14 22:06:34');
INSERT INTO `order` VALUES ('190110000004', '19010610004', '1901001', '439000.00', '1', '2019-01-10 20:46:52', '2019-01-20 20:46:52', '2019-05-21 15:23:05');
INSERT INTO `order` VALUES ('190110000005', '19010610005', '1901001', '629000.00', '2', '2019-01-10 20:47:16', null, '2019-01-10 21:02:28');
INSERT INTO `order` VALUES ('190110000006', '19010610005', '1901001', '507000.00', '1', '2019-01-10 20:47:29', '2019-01-20 12:23:24', '2019-05-21 15:23:01');
INSERT INTO `order` VALUES ('190111000001', '19011010002', '1810001', '629000.00', '1', '2019-01-11 10:59:47', '2019-05-20 10:06:47', '2019-05-21 15:22:54');
...
INSERT INTO `order` VALUES ('190111000004', '19011010003', '123456', '523000.00', '1', '2018-12-11 13:25:01', '2019-06-13 13:27:21', '2019-06-14 22:07:12');
...
INSERT INTO `order` VALUES ('190114000003', '19011410001', '1810002', '599999.00', '1', '2019-01-14 22:37:48', '2019-06-15 15:11:39', '2019-06-14 22:07:28');
...
INSERT INTO `order` VALUES ('190216000004', '19021610004', '1703001', '599999.00', '1', '2019-02-16 15:16:10', '2019-06-13 15:16:10', '2019-06-14 22:09:18');
INSERT INTO `order` VALUES ('190216000005', '19021610003', '1812001', '599999.00', '1', '2019-02-16 15:16:53', '2019-05-08 15:24:01', '2019-05-08 15:24:01');
INSERT INTO `order` VALUES ('190216000006', '19011210007', '1901001', '178000.00', '0', '2019-02-16 15:17:47', null, '2019-02-16 15:17:47');
INSERT INTO `order` VALUES ('190505000001', '19010610001', '123456', '578000.00', '0', '2019-05-05 12:59:33', null, '2019-05-21 16:01:37');
INSERT INTO `order` VALUES ('190513000001', '19010610001', '123456', '439000.00', '0', '2019-05-13 21:30:24', null, '2019-05-21 16:04:32');
INSERT INTO `order` VALUES ('190521000001', '19010610001', '123456', '629000.00', '1', '2019-05-21 15:55:03', '2019-05-21 16:00:43', '2019-05-21 16:00:43');
INSERT INTO `order` VALUES ('190522000001', '19010610001', '123456', '169800.00', '0', '2019-05-22 15:36:09', null, '2019-05-22 15:36:09');
...
CREATE TABLE `order_details` (
  `id` varchar(16) NOT NULL COMMENT '订单详情编号',
  ...
  CONSTRAINT `order_details_ibfk_3` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`),
  CONSTRAINT `order_details_ibfk_4` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `order_details` VALUES ('6000000316040336', '190522000001', '19052200001', '1');
...
INSERT INTO `order_details` VALUES ('6000000543973975', '190521000001', '19010400004', '1');
...
INSERT INTO `order_details` VALUES ('6000001155361126', '190513000001', '19010400002', '1');
...
INSERT INTO `order_details` VALUES ('6000001726405194', '190505000001', '19010400005', '1');
...
-- ----------------------------
INSERT INTO `reservation` VALUES ('19060210001', '王晓', '15663630333', '371311201901010001', '女', '2019-06-30');
INSERT INTO `reservation` VALUES ('19061410001', '尹巧伟', '18866660001', '513436200006146279', '男', '2019-06-15');
INSERT INTO `reservation` VALUES ('19061410002', '伏彩', '18866660002', '513436200006149795', '女', '2019-06-16');
INSERT INTO `reservation` VALUES ('19061410003', '殷元荔', '18866660003', '513436200006146957', '男', '2019-06-17');
INSERT INTO `reservation` VALUES ('19061410004', '从彩初', '15566660002', '513436200006149357', '女', '2019-06-18');
INSERT INTO `reservation` VALUES ('19061410005', '龙晓', '15566660003', '513436200006147255', '男', '2019-06-19');
...
CREATE TABLE `series` (
  ...
  `series_name` varchar(16) NOT NULL COMMENT '车系名称',
  `status` varchar(1) NOT NULL DEFAULT '1' COMMENT '车系状态（0：删除状态，1：正常状态）',
...
-- Records of service
-- ----------------------------
INSERT INTO `service` VALUES ('19061210001', '刘旭', '13331233213', '2019-06-13', '为人民服务');
INSERT INTO `service` VALUES ('19061410001', '凤娟娥', '19966660001', '2019-06-01', '为人民服务');
INSERT INTO `service` VALUES ('19061410002', '蒋民', '19966660002', '2019-06-15', '为人民服务');
INSERT INTO `service` VALUES ('19061410003', '司空姬', '19955556666', '2019-06-17', '为人民服务');
INSERT INTO `service` VALUES ('19061410004', '连中清', '13315892061', '2019-06-19', '为人民服务');
INSERT INTO `service` VALUES ('19061410005', '萧友', '16602663211', '2019-06-19', '为人民服务');
